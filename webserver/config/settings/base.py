...
MIGRATION_MODULES = {"sites": "fca.contrib.sites.migrations"}
...
# https://docs.allauth.org/en/latest/account/configuration.html
ACCOUNT_ADAPTER = "fca.users.adapters.AccountAdapter"
# https://docs.allauth.org/en/latest/account/forms.html
ACCOUNT_FORMS = {"signup": "fca.users.forms.UserSignupForm"}
